...
* auto-cancels CI runs on Azure Pipelines for pull requests that are not based on a branch from a fork
...
| `@ansibot !needs_collection_redirect` | Issues and pull requests | Anyone    | Use this command if bot made a mistake in deciding an issue or pull request was for a file in a collection. Ansible Core team member will need to re-open the issue/PR. Contact a Core team member to review the issue/PR on https://forum.ansible.com.                             |
