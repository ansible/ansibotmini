...
@pytest.fixture
def existing_files():
    with open(os.path.join(os.path.dirname(__file__), "existing_files")) as f:
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("Module: unarchive", ["lib/ansible/plugins/action/unarchive.py", "lib/ansible/modules/unarchive.py"]),
        ("template", ["lib/ansible/plugins/action/template.py", "lib/ansible/modules/template.py", "lib/ansible/plugins/lookup/template.py"]),
        ("unarchive", ["lib/ansible/plugins/action/unarchive.py", "lib/ansible/modules/unarchive.py"]),
        ...
        ("ansible.builtin.file", ["lib/ansible/modules/file.py", "lib/ansible/plugins/lookup/file.py"]),
...
def test_component_matcher(existing_files, in_data, expected):
    assert sorted(match_existing_components(process_component(in_data), existing_files)) == sorted(expected)
